...
const data_nacs_05′ = NaCsData.map_params((i, v)->v - param_1[3], data_nacs_05)
const data_nacs_06′ = NaCsData.map_params((i, v)->v - param_1[3], data_nacs_06)
const data_nacs_10′ = NaCsData.map_params((i, v)->v - param_1[3], data_nacs_10)
const data_nacs_28′ = NaCsData.map_params((i, v)->v - param_1[3], data_nacs_28)
...
plot(plot_freq .- param_1[3], model_2d.(0.05, plot_freq, (param_1,)), "C1")
NaCsPlot.plot_survival_data(data_nacs_06′, fmt="C2.", label="0.06 ms")
plot(plot_freq.- param_1[3], model_2d.(0.06, plot_freq, (param_2,)), "C2")
NaCsPlot.plot_survival_data(data_nacs_10′, fmt="C3.", label="0.10 ms")
plot(plot_freq .- param_1[3], model_2d.(0.10, plot_freq, (param_1,)), "C3")
NaCsPlot.plot_survival_data(data_nacs_28′, fmt="C4.", label="0.28 ms")
plot(plot_freq .- param_1[3], model_2d.(0.28, plot_freq, (param_1,)), "C4")
...
figure()
NaCsPlot.plot_survival_data(data_pa_m2, fmt="C0.")
plot(plot_pa_time, model_exp(plot_pa_time, gen_exp_param(fit.param, 4, 8)), "C0-")
...
figure()
NaCsPlot.plot_survival_data(data_nacs_m, fmt="C0.")
plot(plot_m_time, model_expoff(plot_m_time, gen_exp_param(fit.param, 5, 9, 2)), "C0-")
text(0.08, 0.07, "\$\\tau_{molecule}=$(1000 / uncs_1[6])\\ \\mathrm{\\mu s}\$", color="C0")
xlim([0, 0.32])
grid()
xlabel("Molecule hold time (ms)")
