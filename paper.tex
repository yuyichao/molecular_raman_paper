...
\textcolor{red}{Jon: be more clear with "molecule loss". I think you mean:
  resulting in large incoherence and loss to other molecular states.}\todo{}.
...
where $ \omega_{\text{trap}} $ is the trap frequency\textcolor{blue}{(cite Julienne, a pra in 90s, check ref 43?)}.
...
\textcolor{red}{A target spin state is ideally similar to the initial spin state
  ...
  instead of $0.3\%$ which is typical for other states.}\todo{}
