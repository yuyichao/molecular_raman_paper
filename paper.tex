...
\begin{figure*}
  ...
  \caption{Raman transition parameters as a function of tweezer and Raman power and detuning.
    (a) The light shift of the Raman resonance fitted to$a(P)+b(P)/\Delta$, where
    $a(P)$ and $b(P)=(\Omega_a^2-\Omega_m^2)/2$
    ...
    The $a(P)$s are fitted to a model including linear and small quadratic light shift
    ...
    (b) Raman Rabi frequency ($\Omega_R$) fitted to$c(P)+d(P)/\Delta$, where
    $c(P)$ and $d(P)=\Omega_a\Omega_m/2$
    are tweezer power dependent background and $v'=0$ contribution.
    The detuning is calculated using the PA frequency fitted in (a).
    The $c(P)$s and $d(P)$s are proportional to $P^{1.29}$
    and the fit gives $c(P)/P^{1.29}=-2\pi\times0.41(2)~\mathrm{kHz/mW^{1.29}}$
    and $d(P)/P^{1.29}=-4\pi^2\times167(2)~\mathrm{kHz/mW^{1.29}}$.
    ...
    $b(P)$ and $d(P)$ on a log-log scale showing the $P^{0.5}$ scaling of $\Omega_m$ and
...
\begin{table}[ht]
  \centering
  \begin{tabular}{|c|c|}
    $f_{\mathrm{PA}0}$&$288711.8~\mathrm{GHz}$\\\hline
    $a(0.75~\mathrm{mW})$&$770.20452(6)~\mathrm{MHz}$\\
    $b(0.75~\mathrm{mW})$&$-12.46(2)~\mathrm{MHz\cdot GHz}$\\
    $a(1.5~\mathrm{mW})$&$770.2081(1)~\mathrm{MHz}$\\
    $b(1.5~\mathrm{mW})$&$-24.44(3)~\mathrm{MHz\cdot GHz}$\\
    $a(3.75~\mathrm{mW})$&$770.1943(3)~\mathrm{MHz}$\\
    $b(3.75~\mathrm{mW})$&$-60.66(8)~\mathrm{MHz\cdot GHz}$\\\hline
    $c(0.75~\mathrm{mW})$&$-2\pi\times0.29(2)~\mathrm{kHz}$\\
    $d(0.75~\mathrm{mW})$&$-4\pi^2\times115(4)~\mathrm{kHz\cdot GHz}$\\
    $c(1.5~\mathrm{mW})$&$-2\pi\times0.63(4)~\mathrm{kHz}$\\
    $d(1.5~\mathrm{mW})$&$-4\pi^2\times275(6)~\mathrm{kHz\cdot GHz}$\\
    $c(3.75~\mathrm{mW})$&$-2\pi\times2.4(2)~\mathrm{kHz}$\\
    $d(3.75~\mathrm{mW})$&$-4\pi^2\times0.95(3)~\mathrm{MHz\cdot GHz}$\\
  \end{tabular}
...
$2\pi\times180.87(7)~\mathrm{MHz}/\sqrt{\mathrm{mW}}$.
