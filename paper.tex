...
Pioneering experiments used weakly bound molecular excited states in the Raman transition to ensure a large Raman Rabi frequency, but such choice of state also increases the scattering during the transfer process to render it incoherent, resulting in molecule loss~\cite{Wynar2000,Rom2004}.
