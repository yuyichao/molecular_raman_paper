...
Namely, despite a smaller Raman Rabi frequency at deeply bound intermediate states, the Rabi frequency to scattering rate ratio is much higher as compared to a weakly bound intermediate state. As a result, we choose a deeply bound molecular excited state ($v'=0$ of $c^3\Sigma^+$) to drive the Raman transition. (mention the trend, also v=12 will work as similarly as v=0)
