...
\author{Kenneth Wang}
\author{J. D. Hood}
\altaffiliation{Department of Chemistry, Purdue University, West Lafayette, Indiana, 47907, USA}
\author{Lewis Picard}
\author{Jessie T. Zhang}
\author{William Cairncross}
\author{Jeremy Hutson}
\altaffiliation{Department of Chemistry, Durham University, Durham, DH1 3LE, United Kingdom}
...
\begin{abstract}
  ...
  and lifetime up to $1 \mathrm{ms}$ with more than $60\%$ of the molecule created in the
...
or $2\pi5.324(73)\mathrm{kHz}$ at $15 \mathrm{mW}$ tweezer power.
Together with the $\Omega_m$ measured above, the up leg Rabi frequency is
$2\pi11.53(16)\mathrm{MHz}$.
