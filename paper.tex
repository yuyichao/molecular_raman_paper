...
\begin{abstract}
  Fully controlled single molecules provide a promising platform
  for a variety of quantum science applications.
  As a step towards this goal, we report on coherent association
  of a single weakly bound NaCs molecule in an optical tweezer
