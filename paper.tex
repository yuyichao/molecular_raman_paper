...
\begin{figure*}
  ...
  \caption{Optical creation of single molecules from single atoms in an optical tweezer.
    ...
    The lasers are detuned by $\Delta$ from an excited molecular state
    in the $\mathrm{c^3\Sigma}$ electronic state
