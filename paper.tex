...
with the other combinations, and thus relaxing the intensity stability requirement to the few percent level. % Thus, instead of a required intensity stability of $0.3 ~\mathrm{\%} $ for the 4422 or 3311 combination, the 3322 combination only requires the intensity to be stabilized to $ 5~\mathrm{\%} $.
...
\begin{figure}[ht!]
  ...
  \caption{
    ...
    the down leg power ramped up over $10~\mathrm{\mu s}$
...
the requirement on the tweezer power stability is $0.8~\mathrm{\%}$ at $15~\mathrm{mW}$.
