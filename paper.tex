...
The measured single-photon Rabi frequencies of Table~I are in broad agreement with calculations (see Supplementary Materials). The full calculation of the expected scattering rate of the molecular and atomic state including all excited states does not explain the decoherence
