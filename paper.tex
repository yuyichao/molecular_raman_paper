...
Optical association that can be applied to a wider range of molecule
have also been demonstrated~\cite{Wynar2000,Rom2004}
but the transition is generally incoherent,
which limits their use to spectroscopic study of the molecular structure,
rather than creating and controlling the molecules.
