...
Exceptions are Sr$_2$, where narrow linewidth ($\sim 20~\mathrm{kHz}$) excited states
...
and is chosen to minimize theoretical photon scattering during Raman Rabi oscillations
...
{\color{red} To identify a suitable target molecular state, we carry out coupled-channel calculations of the near-threshold bound states, as described in the Supplemental Material.
  ...
  The coupled-channel calculations show that this target molecular state has lower overlap with the intermediate state, compared to bound states of other spin compositions.
  ...
  This further increases the ratio $\Omega_a/\Omega_m$ when starting from atoms in the $\ket{\uparrow_{\Na} \downarrow_{\Cs}}$ hyperfine combination.}
