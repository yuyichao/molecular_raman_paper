...
\begin{tikzpicture}[scale=1.3593]
  ...
  \node at (-0.1cm - 1pt, 0) {\includegraphics[height=4.7577cm]{scaling_light_shift.pdf}};
  \node at (-2.0cm - 1pt, 1.5) {\footnotesize (\textbf{a})};
  % offset = -2pi 68.0(53) Hz/mW^-1.29
  % strength = 2pi 25.79(60) kHz GHz/mW^-1.29
  \node at (4.45, 0) {\includegraphics[height=4.7577cm]{scaling_rabi.pdf}};
  \node at (2.5, 1.5) {\footnotesize (\textbf{b})};
  \node at (8.1cm + 1pt, 0) {\includegraphics[height=5.0296cm]{scaling_560.pdf}};
