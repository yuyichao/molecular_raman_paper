...
\begin{tikzpicture}[scale=1.3593]
  ...
  \node at (-0.1cm - 1pt, 0) {\includegraphics[height=4.7577cm]{imgs/scaling_light_shift.pdf}};
  ...
  \node at (4.45, 0) {\includegraphics[height=4.7577cm]{imgs/scaling_rabi.pdf}};
  \node at (2.5, 1.5) {\footnotesize (\textbf{b})};

  % omega_m: 2pi 90.434(34) MHz/mW^0.5
  % omega_a: 2pi 617.1(92) kHz/mW^0.79
  \node at (8.1cm + 1pt, 0) {\includegraphics[height=5.0296cm]{imgs/scaling_slopes.pdf}};
