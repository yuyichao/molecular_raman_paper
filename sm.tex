...
\begin{figure}[ht!]
  ...
  \caption{Electronic transition dipole moments calculated via ab initio methods between different electronic states of NaCs. These transition dipole moments are shown in units of $ea_0$, where $ e $ is the  are shown as a function of internuclear distance, $ R $.
    \label{tdm-sm}}
\end{figure}
