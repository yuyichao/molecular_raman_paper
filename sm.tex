...
nuclear spin character, which is unknown. These calculations include the electronic transition dipole moment that depends on the internuclear distance. These were calculated ab initio by \textcolor{red}{Should we just mention Mosynski or Rosario? or say something about the ab initio method and give a citation.}
