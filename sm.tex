...
\begin{figure}[ht!]
  ...
  \caption{Electronic transition dipole moments calculated via ab initio methods between different electronic states of NaCs. These transition dipole moments are shown as a function of internuclear distance.
    \label{tdm-sm}}
\end{figure}
