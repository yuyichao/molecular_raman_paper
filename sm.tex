...
nuclear spin character, which is unknown. These calculations include theoretical electronic transition dipole moments shown in figure \ref{tdm-sm} calculated with \textit{ab initio} methods~\footnote{Private communication with R. Moszynski}.
...
\begin{figure}[ht!]
  \includegraphics[width=\textwidth]{imgs/fcf_c3sigma_wide.pdf}
