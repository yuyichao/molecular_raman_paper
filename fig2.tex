...
\begin{tikzpicture}[scale=1.27]
  \node at (0, 0) {\includegraphics[width=6.75cm]{imgs/exp_data_norm_raman_det.pdf}};
  \node at (-2.15, 1.9) {\footnotesize (\textbf{a})};
  ...
  \end{scope}
  \node at (-2.15, -2.1) {\footnotesize (\textbf{b})};
  \node at (0.8, -3.1) {\includegraphics[width=4.2cm]{imgs/apparatus}};
\end{tikzpicture}
