...
NaCsPlot.plot_survival_data(data_nacs_12′, fmt="C1o", label="0.12 ms")
plot(plot_freq .- param_1[3], model_2d.(0.12, plot_freq, (param_1,)), "C1")
NaCsPlot.plot_survival_data(data_nacs_25′, fmt="C2o", label="0.25 ms")
...
xlim([-14, 11])
ylim([0.08, 1.06])
legend(fontsize=13, loc="lower left", handlelength=0.6, handletextpad=0.3)
grid()
xlabel("Raman Detuning (kHz)", fontsize=15)
# ylabel("Fraction of Atomic Ground State")
...
function plot_lorentz()
    NaCsPlot.plot_survival_data(data_nacs_12_shift, fmt="C0o", label="0.12 ms")
...
function plot_lorentz_norm()
    NaCsPlot.plot_survival_data(data_nacs_12_shift, scale_1, fmt="C0o", label="0.12 ms")
...
figure()
NaCsPlot.plot_survival_data(data_nacs_t, fmt="C0o", label="770.5704 MHz")
...
xlabel("Raman Time (ms)")
ylabel("Fraction of Atomic Ground State")
NaCsPlot.maybe_save("$(prefix)_norm_t_annotate")
...
figure()
NaCsPlot.plot_survival_data(data_pa_m, fmt="C0o")
...
figure()
NaCsPlot.plot_survival_data(data_nacs_m[1:end - 1], fmt="C0o")
