...
const rabi_freqs = [560 15 3.971 0.089
                    560 6 1.182 0.033
                    560 3 0.488 0.015
...
errorbar(plot2.x[1] / 4, (plot2.y[1] .- fit_res.param[1]) .* 1000,
         plot2.unc[1] .* 1000, fmt="C0o")
errorbar(plot2.x[2] / 4, (plot2.y[2] .- fit_res.param[1]) .* 1000,
         plot2.unc[2] .* 1000, fmt="C1o")
...
errorbar(plot2.x[1] / 4, plot2.y[1], plot2.unc[1], fmt="C0o")
